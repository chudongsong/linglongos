  ...
  describe('导出完整性检查', () => {
    it('应该导出所有期望的模块', () => {
      const expectedExports = [
        ...
        // 数据处理
        'DataType', 'deepClone', 'deepMerge', 'uniqueArray', 'groupBy', 'sortBy', 
        'paginate', 'flattenArray', 'flattenTree', 'arrayToTree',
        
        // 字符串处理
        'truncate', 'pad', 'toCamelCase', 'toPascalCase', 'toKebabCase', 
        'toSnakeCase', 'toTitleCase', 'removeWhitespace', 'template', 'formatJson',
        'removeHtmlTags', 'removeExtraWhitespace', 'getFileExtension', 'highlightKeywords',
        'capitalize', 'titleCase', 'maskPhone', 'maskEmail', 'maskIdCard', 'maskBankCard',
        'StringUtils',
        
        // 数字处理
        'toThousands', 'formatFileSize', 'toPercent', 'toCurrency', 'toChineseNumber',
        'toRoman', 'formatRange', 'randomInt', 'randomFloat', 'clamp', 'NumberUtils',
        
        // 日期处理
        'formatDate', 'getRelativeTime', 'formatDuration', 'getFriendlyDate', 'getWeekday',
        'getDateRange', 'isLeapYear', 'getDaysInMonth', 'DateUtils',
        
        // 文件处理
        'FileTypeMap', 'FileUtils', 'MimeTypeMap', 'getMimeType',
        
        // URL处理
        'parseUrlParams', 'buildUrlParams', 'addUrlParams', 'removeUrlParams',
        'getDomain', 'getProtocol', 'getPath', 'isValidUrl', 'isHttpUrl', 'isRelativeUrl',
        'toAbsoluteUrl', 'formatUrl', 'getFilenameFromUrl', 'getExtensionFromUrl',
        'buildApiUrl', 'parsePathParams',
        
        // 验证
        'RegexPatterns', 'Validator', 'checkPasswordStrength',
        
        // 格式化
        'NumberFormat', 'DateFormat', 'StringFormat', 'ColorFormat',
      ]
