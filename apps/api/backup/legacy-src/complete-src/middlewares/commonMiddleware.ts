...
import type { SuccessResponse, ErrorResponse } from '../types/index'
 ...
 * ```
 */
export function formatSuccess<T>(data: T, message = '成功'): SuccessResponse<T> {
 ...
 * ```
 */
export function formatError(code: number, message: string, data?: unknown): ErrorResponse {
