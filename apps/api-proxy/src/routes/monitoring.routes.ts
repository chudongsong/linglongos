...
router.get('/stats', asyncHandler(async (req: Request, res: Response) => {
  ...
  const dailyStats = await apiLogRepository.getDailyStats(
    dailyDateFrom,
    dailyDateTo,
    req.user.userId
  );
 ...
 */
router.get('/system', requireAdmin, asyncHandler(async (req: Request, res: Response) => {
  try {
    // Get system-wide statistics
 ...
 */
router.delete('/logs/cleanup', requireAdmin, asyncHandler(async (req: Request, res: Response) => {
