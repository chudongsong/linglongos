				...
				<form @submit.prevent="handleSubmit" class="login-form">
					...
					<div class="form-options">
						<label class="remember-me">
							<input id="remember-me" v-model="formData.rememberMe" type="checkbox" class="checkbox-input" />
...
<script setup lang="ts">
	...
	const isFormValid = computed(() => {
		return (
			formData.value.email.trim() !== '' && formData.value.password.trim() !== '' && formData.value.email.includes('@')
		)
	})
