<template>
  <div class="not-found-container">
    <div class="text-center">
      <!-- 404 图标 -->
      <div class="mb-8">
        <div class="mx-auto w-32 h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <button
          @click="goBack"
          class="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors flex items-center space-x-2"
        >
      ...
      <!-- 建议链接 -->
      <div class="mt-12">
        <p class="text-sm text-gray-500 dark:text-gray-500 mb-4">您可能想要访问：</p>
